...
public class TestSeqFuncService {
    final static private long THREAD_MAX_RUNTIME = 100000;

    private static final ZTEsoftLogManager logger = ZTEsoftLogManager
            .getLogger(TestSeqFuncService.class);

    @Resource(name = "sequenceFuncGenerator")
    private ISequenceGenerator sequenceGenerator;

    @Autowired
    private SequenceFuncDao sequenceFuncDao;

    private Map<String, Object> resultMap = new HashMap<String, Object>();

    private MySeqFuncThread[] threadArray = new MySeqFuncThread[10];
     ...
     * @see com.ztesoft.web.demo.service <br>
     */
    class MySeqFuncThread implements Runnable {
        ...
        public void run() {
            Long[] result;
            try {
                result = sequenceGenerator.sequenceBatchLongValue("AM_USER",
                        "USER_ID", "DEF", 1);
    ...
    class MySeqDaoThread implements Runnable {
        ...
        public void run() {
            ...
            params.put("tableName", "AM_USER");
            params.put("columnName", "USER_ID");
    ...
    public void threadPoolTest() {
        ...
        for (int i = 0; i < 10; i++) {
            // executor.execute(new MySeqFuncThread());
