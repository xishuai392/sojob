...
public class EhcacheController {
    ...
    public Page<EhcachePO> queryRecordByPage(EhcachePO record,
        ...
        if(resultPage.getTotalRecords()>11){
            throw ExceptionHandler.publish("APP-00-0016");
        }
        return resultPage;
    }
    ...
    @ResponseBody
    public EhcachePO update1(EhcachePO record) throws BaseAppException {
    ...
    @ResponseBody
    public EhcachePO update(EhcachePO record) throws Exception {
        logger.debug("modify record begin...record=[{0}]", record);
        //测试动态数据源
        ehcacheService.update4TestDynaicDataSource(record);
        return record;
    }
