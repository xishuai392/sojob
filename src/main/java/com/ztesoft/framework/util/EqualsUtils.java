...
/**
 * <Description> 相等性比较类<br>
 * 
 * @version 1.0<br>
 * @taskId <br>
 * @CreateDate 2014年8月29日 <br>
 * @since V1.0<br>
...
public final class EqualsUtils {
    ...
    /**
     * 比较字符串是否相等(去掉首尾的空格之后再比较),调用对象的equals()方法来比较. 当对象为null时不会抛出NullPointerException异常.
     * 
     * @param a String
     * @param b String
     * @return boolean true-相等, false-不相等
    ...
    /**
     * 比较两个字符串是否相等, 忽略大小写.调用对象的equalsIgnoreCase()方法来比较. 当对象为null时不会抛出NullPointerException异常.
     * 
     * @param a String
     * @param b String
     * @return boolean true-相等, false-不相等
     ...
     * <p>
     * 当比较两个对象时候, 如果返回值为0则表示对象已经不相同,不用再比较,如果返回 1表示两个对象相同,也不用再比较,如果返回2表示两个对象属于一个类,还需进一步比较.
     * </p>
     * 
     * @param a Object
     * @param b Object
