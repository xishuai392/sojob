...
public final class DateUtils {
    ...
    public static ThreadLocal<SimpleDateFormat> SIMPLE_DATE_FORMAT_yyyy = new ThreadLocal<SimpleDateFormat>() {
        @Override
        protected SimpleDateFormat initialValue() {
            return new SimpleDateFormat(STR_DATE_FORMAT_YEAR);
        }
    };

    /** SimpleDateFormat. yyyyMMdd */
    public static ThreadLocal<SimpleDateFormat> SIMPLE_DATE_FORMAT_yyyyMMdd = new ThreadLocal<SimpleDateFormat>() {
        @Override
        protected SimpleDateFormat initialValue() {
            return new SimpleDateFormat(STR_DATE_FORMAT_DAY_WITHOUT_SPLIT);
        }
    };

    /** SimpleDateFormat. yyyyMMddhhmmss */
    public static ThreadLocal<SimpleDateFormat> SIMPLE_DATE_FORMAT_yyyyMMddhhmmss = new ThreadLocal<SimpleDateFormat>() {
        @Override
        protected SimpleDateFormat initialValue() {
            return new SimpleDateFormat(STR_DEFAULT_DATE_FORMAT_WITHOUT_SPLIT);
        }
    };

    /** SimpleDateFormat. yyyy-MM-dd HH:mm:ss */
    public static ThreadLocal<SimpleDateFormat> SIMPLE_DATE_FORMAT_yyyy_MMdd_HHmmss = new ThreadLocal<SimpleDateFormat>() {
        @Override
        protected SimpleDateFormat initialValue() {
